...
export function Platform() {
    return (
        <section id="platform" className="py-32 bg-gray-50 relative overflow-hidden">
            {/* Background Elements */}
            ...
            <div className="container px-4 md:px-6 mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
                    {differentiators.map((item, index) => (
                        <motion.div
                            ...
                            className="group bg-white rounded-3xl p-8 border border-gray-200 hover:shadow-xl transition-all duration-500"
                        >
                            <div className="flex items-start gap-6">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-500 italic mb-3">{item.details}</p>
                                    <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
                                        <p className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Key Metrics</p>
                                        <p className="text-sm font-semibold text-gray-800">{item.stats}</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                ...
                >
                    <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                            <h3 className="text-xl font-bold text-black mb-3">Swiss Banking Excellence</h3>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                {custodianBanks.map((bank, index) => (
                                    <div key={bank.name} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
